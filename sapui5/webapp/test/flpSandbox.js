			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SRsapui5-display": {
								"semanticObject": "SRsapui5",
								"action": "display",
								"description": "app fiori dev",
								"title": "SAPUI5 FIORI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=SR.sapui5",
									"url": sap.ui.require.toUrl("SR/sapui5")
								}
							}
						}
					}
